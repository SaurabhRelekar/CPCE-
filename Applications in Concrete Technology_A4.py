...
# Maximum free Water Cement Ratio # Reference IS 456: 2000 Table 5

if(Concreting == "Plain”):
WC_ratio = { "Mild" : 0.6,
"Moderate" :0.6,
"Severe" :0.5,
"Very Severe" :0.45, "Extreme”:0.4
...
# M1n1mum Cement Content

if(Concreting == “plain”): Min_Cement_Content = { "Mild”:220.
...
else: Min_Cement_Content = { "Mild”: 300,
"Moderate“ :300 ,
"Severe” : 320,
"Very Severe" :340,
"Extreme”: 360
...
Nater_Content = Water_Content - 25
...
Cement_Content = Water_Content/WC_ratio print(“Cement Content:”, Cement_Content, “kg/m’3”)

print(“As Per IS 456:2000, Maximum allowed Cement Content is 450 kg/m’3”)
 

if (Cement_Content< 450): Cement_Content = Cement_Content else:
Cement_Content = 450
if Cement_Content< 450: print(“Safe“)

# Volume Calculations
Vol_Cement = Cement_Content/(Gc*Water_Density) print(”Volume of Cemnet: ", Vol_Cement, "m’3”)

Vol_Water = Water_Content/Water_Density print(“Volume of Water: ", Vol_Water, "m’3”)
...
Fraction = Zone_ID[Zone] [AGG_Size] if (WC_ratio==0.5) :
Fraction=Fraction
elif (WC_ratio==0.45) :
Fraction=Fraction+(0.01*Fraction) elif (WC_ratio==0.4):
Fraction=Fraction+(0.02 * Fraction) elif (WC_ratio==0.55):
Fraction=Fraction-(0.01*Fraction) elif (WC_ratio==0.60):
Fraction=Fraction-(0.02*Fraction) print(“Course Aggregate fraction:“, Fraction)
...
print(Cement_Content/Cement_Content,":", Mass_FA/Cement_Content,”:”, Mass_CA/Cement_Content,":",Wat
 
print ”voiume Datcning:"
print(Vol_Cement/Vol_Cement,”:“, Vol_FA/Vol_Cement,”:“, Vol_CA/Vol_Cement,“:" , Vol_Water/Vol_Cemen
